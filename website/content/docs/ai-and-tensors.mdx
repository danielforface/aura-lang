---
title: "AI & Tensors"
description: "The current AI/tensor language and plugin direction, separated from broader â€œAI-nativeâ€ marketing claims."
---

Auraâ€™s current compact reference includes resource-like types such as `Tensor` and `Model`, and the workspace contains `aura-plugin-ai`, `aura-ai-opt` plus ONNX Runtime bridge assets/examples.
...
`Tensor` and `Model` are included among resource-like types in the current referenceâ€™s move-oriented MVP rules. Broader ownership/linearity infrastructure exists in the compiler and verifier, but those guarantees remain pre-stable.
