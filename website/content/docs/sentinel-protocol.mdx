...
The repositoryâ€™s LSP stability document currently identifies Aura protocol version `1`. Breaking Aura-specific extension changes should bump that protocol version rather than silently changing client assumptions.
